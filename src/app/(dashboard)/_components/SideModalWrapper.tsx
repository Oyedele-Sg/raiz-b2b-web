  ...
  return (
    <Overlay close={close}>
      <motion.div
        ...
        key="modal"
        className={`p-[25px] xl:p-[30px] bg-raiz-gray-50 no-scrollbar  justify-start gap-2 inline-flex fixed right-0 md:top-0 bottom-0 w-full md:w-[50%] lg:w-[31%] xl:w-[28.57%] ${
          isMobile
