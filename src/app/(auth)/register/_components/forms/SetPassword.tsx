        ...
        <div className="flex flex-col xl:pb-20">
          ...
          <div className="flex flex-col gap-[15px] mt-5">
            <div className="flex gap-3">
              ...
              <span className="text-raiz-gray-700 text-[13px] font-normal font-monzo leading-[18px]">
            ...
            <div className="flex gap-3">
              ...
              <span className="text-raiz-gray-700 text-[13px] font-normal font-monzo leading-[18px]">
                Password must container at least 2 of these rules: one upper
                case letter, one lower case letter, one numeric character, one
                special character
              </span>
            </div>
          </div>
