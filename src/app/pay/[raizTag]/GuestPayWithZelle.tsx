    ...
    return (
        <>
            <div className='flex h-[80%] flex-col gap-8 justify-between'>
                <div className="mb-8 text-center">
                    <div className='mx-auto w-full mb-5 flex justify-center items-center'>
                        <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.304443" y="0.304321" width="30" height="30" rx="15" fill="#EAECFF" />
                            <rect x="0.304443" y="0.304321" width="30" height="30" rx="15" stroke="#E4E0EA" strokeWidth="0.608696" />
                            <path d="M18.7545 7.77102L11.2295 10.271C6.17121 11.9627 6.17121 14.721 11.2295 16.4044L13.4629 17.146L14.2045 19.3794C15.8879 24.4377 18.6545 24.4377 20.3379 19.3794L22.8462 11.8627C23.9629 8.48769 22.1295 6.64602 18.7545 7.77102ZM19.0212 12.2544L15.8545 15.4377C15.7295 15.5627 15.5712 15.621 15.4129 15.621C15.2545 15.621 15.0962 15.5627 14.9712 15.4377C14.7295 15.196 14.7295 14.796 14.9712 14.5544L18.1379 11.371C18.3795 11.1294 18.7795 11.1294 19.0212 11.371C19.2629 11.6127 19.2629 12.0127 19.0212 12.2544Z" fill="#4B0082" />
                        </svg>
                    </div>
                    <p className="text-sm text-raiz-gray-950 mb-3">How much do you want to send?</p>
                ...
                <Button loading={zelleMutation.isPending} disabled={!amount || zelleMutation.isPending} onClick={() => zelleMutation.mutate({ expected_amount: parseFloat(amount || "0") })}>
                    Continue
                </Button>
            </div>
            {showZelleInfo && <ZelleTopupInfo goBack={() => setShowZelleInfo(false)}
                goNext={() => {
                    handleDone();
                    toast.success(
